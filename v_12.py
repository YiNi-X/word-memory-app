...
# 4. 页面 UI 设置
# ==========================================
st.set_page_config(page_title="NEURAL_MODULAR_SYSTEM_V12", page_icon="⚡", layout="wide")

st.markdown("""
<style>
    .stApp { background-color: #050505; color: #e0e0e0; font-family: 'Courier New', monospace; }
    /* 🟠 V12 验证色：橙色 */
    h1 { color: #ffaa00 !important; text-shadow: 0 0 10px #ffaa00; }
...
with tab_article:
    if status == 'generating_article':
        ...
        # ⚠️ 关键修改：st.rerun() 移到了 try/except 之外！
        if success:
